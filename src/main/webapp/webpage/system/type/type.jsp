...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType">
	...
	<fieldset class="step">
	<div class="form"><label class="Validform_label"> 参数名称: </label> <input name="typename" class="inputxt" value="${type.typename }" datatype="s1-15"> <span class="Validform_checktip">类型范围在1~15位字符</span>
	</div>
