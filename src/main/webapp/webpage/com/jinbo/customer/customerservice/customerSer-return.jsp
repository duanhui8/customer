...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="customerSerController.do?doReturnResult">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value"  colspan="3">
				 <textarea id="acontent" name="acontent"  disabled='true'>${customerSerPage.acontent}</textarea>
				<span class="Validform_checktip"></span>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="customerSerController.do?adviceReplyList2&aorder=${customerSerPage.aorder}" icon="icon-search" title="部门回复" id="deptReply"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
