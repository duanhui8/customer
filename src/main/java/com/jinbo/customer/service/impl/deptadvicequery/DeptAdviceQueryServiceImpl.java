package com.jinbo.customer.service.impl.deptadvicequery;
...
@Service("deptAdviceQueryService")
@Transactional
public class DeptAdviceQueryServiceImpl extends CommonServiceImpl implements DeptAdviceQueryServiceI {
	...
	public void addMain(CustomerSerEntity deptAdviceQuery,
			...
			//保存主信息
			this.save(deptAdviceQuery);
		
			/**保存-回复*/
			for(ServiceReplyEntity adviceReply:adviceReplyList){
				//外键设置
				adviceReply.setAorder(deptAdviceQuery.getAorder());
				this.save(adviceReply);
			}
			//执行新增操作配置的sql增强
 			this.doAddSql(deptAdviceQuery);
	}
	...
	public void updateMain(CustomerSerEntity deptAdviceQuery,
	        List<ServiceReplyEntity> adviceReplyList) {
		//保存主表信息
		this.saveOrUpdate(deptAdviceQuery);
		//===================================================================================
		//获取参数
		...
		//执行更新操作配置的sql增强
 		this.doUpdateSql(deptAdviceQuery);
	}

	
	public void delMain(CustomerSerEntity deptAdviceQuery) {
		//删除主表信息
		this.delete(deptAdviceQuery);
		//===================================================================================
		//获取参数
		Object aORDER0 = deptAdviceQuery.getAorder();
		//===================================================================================
